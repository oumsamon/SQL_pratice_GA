...
-- SELECT * FROM country JOIN countrylanguage on country.code = countrylanguage.countrycode WHERE country.name = 'Holy See (Vatican City State)' AND countrylanguage.language
